...
public class ProductController {
    ...
    public ResponseEntity<?> getProductsByCategoryAndCity(@RequestParam(required=false) String category, @RequestParam(required=false) String city) {
        ...
        if(category == null && city == null){
            ...
            response = new ResponseEntity(productService.getProductsByCategory(category), HttpStatus.OK);
        }else if(category == null) {
            response = new ResponseEntity(productService.getProductsByCity(city), HttpStatus.OK);
        }else{
            response = new ResponseEntity(productService.getProductsByCategoryAndCity(category, city), HttpStatus.OK);
        }
    ...
    public ResponseEntity<?> saveProduct(@RequestBody Product product) {
        ...
        if (productService.findProductByName(product.getProductName()) != null) {
            ...
            response = new ResponseEntity(productService.save(product), HttpStatus.CREATED);
        }
    ...
    public ResponseEntity<?> updateProduct(@RequestBody Product product) {
        ...
        if (productService.findById(product.getId()) == null) {
            ...
            response = new ResponseEntity(productService.update(product), HttpStatus.OK);
        }
