...
public class JwtUtil {
    ...
    /*public String createToken(String subject) {
        ...
        List<GrantedAuthority> grantedAuthorities = AuthorityUtils.commaSeparatedStringToAuthorityList("USER,ADMIN");
    ...
    public String createToken(String subject, User user) {
        ...
        String secretKey = "mySecretKey";
        List<GrantedAuthority> grantedAuthorities = AuthorityUtils.commaSeparatedStringToAuthorityList(user.getUserRole().name());
